classdef RepairableModelGBIP < handle
    % GBIP (See Rathie2006)
    % lambda(t) = alpha * (1 - exp(-t/beta))^gamma;
    %
    % See the references at the end of this file.
    
    properties
        alpha     = nan   % parameter of intensity function (lambda)
        beta      = nan   % parameter of intensity function (lambda)
        gamma     = nan   % parameter of intensity function (lambda)
    ...
    methods
        ...
        function y = lambda(this,t,alpha,beta,gamma)
...
% 
% @article{Rathie2006,
%   title={Repairable systems in reliability theory and applications},
%   author={Rathie, Pushp E and Gomes, Antonio E G},
%   year={2006}
% }